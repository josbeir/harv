...
cli-config-unknown-setting = Unknown setting: { $setting }. Valid settings: access-token, account-id, locale, aliases, cache-ttl
...
cli-config-unknown-setting-set = Unknown setting: { $setting }. Valid settings: cache-ttl, locale
...
tui-app-loading-sync = Syncing with Harvest...
