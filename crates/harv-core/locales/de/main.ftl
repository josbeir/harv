...
cli-connect-method-prompt = Authentifizierungsmethode auswählen:
cli-connect-method-quick = Schnelle Browser-Anmeldung (regelmäßig erneut verbinden)
cli-connect-method-pat = Persönlicher Zugriffstoken (manuell, langfristig)
cli-connect-method-refreshable = Eigene OAuth-Anwendung (automatisch erneuern)
cli-connect-pat-token-prompt = Persönlicher Harvest-Zugriffstoken:
cli-connect-pat-account-prompt = Harvest-Konto-ID:
cli-connect-pat-account-invalid = Die Konto-ID darf nur Ziffern enthalten
cli-connect-client-id-prompt = Harvest OAuth-Client-ID:
cli-connect-client-secret-prompt = Harvest OAuth-Client-Secret:
cli-connect-value-required = Dieser Wert ist erforderlich
...
cli-config-auth-method = Authentifizierung:
cli-config-auth-method-quick = schnelle Browser-Anmeldung
cli-config-auth-method-pat = persönlicher Zugriffstoken
cli-config-auth-method-refreshable = OAuth-Anwendung mit Erneuerung
...
cli-config-unknown-setting = Unbekannte Einstellung: { $setting }. Gültige Einstellungen: access-token, account-id, aliases, cache-ttl, check-updates
cli-config-cache-ttl-invalid = cache-ttl muss eine positive Zahl sein
cli-config-check-updates-invalid = check-updates muss true oder false sein
cli-config-locale-invalid = Invalid locale: { $value }. Supported: { $supported } (or empty/auto to reset)
cli-config-unknown-setting-set = Unbekannte Einstellung: { $setting }. Gültige Einstellungen: cache-ttl, locale, check-updates
...
tui-app-update = v{ $version } verfügbar
...
tui-form-help-create = Tab: nächstes Feld │ Alt+Enter: senden │ Esc: abbrechen
tui-form-help-start = Tab: nächstes Feld │ Alt+Enter: Timer starten │ Esc: abbrechen
tui-form-help-edit = Tab: nächstes Feld │ Alt+Enter: speichern │ Esc: abbrechen
...
tui-app-loading-entries = Lade Zeiterfassungen...
tui-app-loading-assignments = Lade Projektdaten...

# TUI — Dashboard stats footer
tui-dash-projects = Projekte
tui-dash-stats-total = Gesamt
