...
cli-config-unknown-setting = Onbekende instelling: { $setting }. Geldige instellingen: access-token, account-id, aliases, cache-ttl
cli-config-cache-ttl-invalid = cache-ttl moet een positief getal zijn
cli-config-unknown-setting-set = Onbekende instelling: { $setting }. Geldige instellingen: cache-ttl
